...
public class ValidateUpdateCompanyField {
    ...
    public Company validate(Company company, CompanyUpdateRequestDTO companyDTO){
        ...
        if(companyDTO.description() != null) company.setDescription(companyDTO.description());
        if(companyDTO.website() != null) company.setWebsite(companyDTO.website());
        if(companyDTO.password() != null) company.setPassword(encoder.encode(companyDTO.password()));
